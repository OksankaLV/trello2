...
import { activeCard, deActiveCard, setError } from '../../../../store/listSlice';
...
export const CardModalId = (): JSX.Element => {
    ...
    listsStore.map((lists: IList) => { lists.cards.map((element: ICard) => { if (element.id == card_id) { dispatch(activeCard({ card: element, list_id: lists.id})) } }); })
         ...
         <div className='wrapperModal'>
                <div className='bodyModal'>
                    <div className='titleModal'>
                        ...
                        <Link to={`/board/${board_id}`}><button type='button' onClick={() => dispatch(deActiveCard())}> X </button></Link>
                    </div>
